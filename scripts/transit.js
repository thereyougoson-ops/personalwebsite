...
(function () {
  ...
  function buildPanelHTML(b) {
    return '<div style="font-family:\'Geist Mono\',monospace;font-size:11px;color:' + b.accent + ';letter-spacing:.1em;text-transform:uppercase;">' + b.n + ' · ' + esc(b.cat) + (b.isNew ? ' · <span style="color:#5ee6c0;">new</span>' : '') + '</div>'
      ...
      + '<div style="display:flex;gap:14px;margin-bottom:15px;flex-wrap:wrap;">' + b.facts.map(function (f) { return '<div><div style="font-family:\'Space Grotesk\',sans-serif;font-weight:700;font-size:18px;color:' + b.accent + ';">' + f[0] + '</div><div style="font-family:\'Geist Mono\',monospace;font-size:9.5px;color:#8b857b;text-transform:uppercase;">' + f[1] + '</div></div>'; }).join('') + '</div>'
      + '<button type="button" data-launch="' + b.slug + '" style="cursor:pointer;font-family:\'Geist Mono\',monospace;font-size:12.5px;color:#ede8e0;background:' + b.accent + '1f;border:1px solid ' + b.accent + '66;border-radius:9px;padding:11px 15px;display:inline-flex;align-items:center;gap:8px;"><span style="display:inline-grid;place-items:center;width:18px;height:18px;border-radius:50%;background:' + b.accent + ';color:#06060a;font-size:8px;">▶</span> launch live app</button>'
